...
#include <stdio.h>
/**
 * Implementation for generic map for HW4 in CPSC 223.
 * Author: Elizabeth Schaefer
 *
 * implemented all functions described in gmap.h, in adddition to a 
 * gmap_embiggen and gmap_emsmallen function (described)
 */
